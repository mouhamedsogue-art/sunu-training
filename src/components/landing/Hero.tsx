...
import { ChevronRight, Cpu, CheckCircle, Search } from 'lucide-react';
...
const Hero: React.FC<HeroProps> = ({ onCandidateClick, onPartnerClick }) => {
  return (
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <h1 className="text-4xl md:text-7xl font-black leading-[1.1] mb-8 text-slate-900 tracking-tight">
              Connecter les <span className="text-primary italic">talents</span> aux meilleures opportunités professionnelles
            </h1>
            <p className="text-lg md:text-xl text-slate-600 mb-12 max-w-2xl mx-auto lg:mx-0 font-medium leading-relaxed">
              Plateforme digitale de recrutement permettant aux candidats de déposer leurs CV et aux entreprises de trouver rapidement des profils qualifiés.
            </p>
            <div className="flex flex-wrap justify-center lg:justify-start gap-4">
              <Button size="lg" className="h-16 px-10 text-lg font-black rounded-2xl shadow-2xl shadow-primary/30 bg-primary hover:bg-primary/90 transition-all hover:-translate-y-1" onClick={onCandidateClick}>
                Déposer mon CV <ChevronRight className="ml-2 w-5 h-5" />
              </Button>
              <Button size="lg" variant="outline" className="h-16 px-10 text-lg font-black rounded-2xl border-2 border-slate-200 hover:bg-slate-50 transition-all hover:-translate-y-1" onClick={onPartnerClick}>
                <Search className="mr-2 w-5 h-5" /> Rechercher des profils
              </Button>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                <p className="text-[10px] text-primary font-black uppercase tracking-wider mb-1">Analyse sémantique</p>
